    ...
    <div className="max-w-screen-2x1 mx-auto container px-6 py-3 md:px-40">
        <div className="flex h-screen items-center justify-center">
            <div className="border-2 border-dashed px-4 py-2 md:px-8 md:py-6 border-indigo-400 rounded-lg shadow-lg">
                <h1 className="text-3x1 font-bold text-center mb-4">Convert Word to PDF Online</h1>
            ...
            <div className="flex flex-col items-center space-y-4">
                ...
                <FaFileWord  className="text-3x1 mr-3" />
                <span className="text-2x1 mr-2">{selectedFile?selectedFile.name:"ChooseFile"}</span>

            </label>
            <button 
            onClick={handleSubmit}
            disabled={!selectedFile}
            className="text-white bg-blue-500 hover:bg-blue-700 disabled:bg-gray-400 disabled:pointer-events-none duration-300 font-bold px-4 py-2 ro"> 
             Convert File
            </button>
            {convert && (
